...
/**
 * SWD.md step 1a: bit-level verification of the Phase 2A line layer (SwdPhy) with the
 * DP stubbed behind the SwdDpCmd/SwdDpRsp/SwdDpWrite seam. No DebugModule, no LiteX.
 *
 * The probe-side protocol driving lives in SwdHostDriver (shared with the step-1b/2
 * benches); this suite adds the always-ready stub DP and the Phase 2A exit checklist.
 *
